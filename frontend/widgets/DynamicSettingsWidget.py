...
class DynamicSettingsWidget(QWidget):
    ...
    def __init__(self, paramList=None, title=None, on_edit=lambda: None, 
                 submit_on_slider_move=False,
                 enable_scroll_area=True,
                 enable_text_boxes=True,
                 vertical=True,):
        super().__init__()
        self.vertical = vertical
        self.enable_scroll_area = enable_scroll_area
        self.enable_text_boxes = enable_text_boxes
    ...
    def initUI(self):
        ...
        if self.enable_scroll_area:
            ...
            self.setLayout(self.dynamicLayout)
